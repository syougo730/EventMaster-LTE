...
//*************************************************************
// Rule
//1.  use App\Http\Requests\PbScoresValidation; //Add Controller
//2.  public function store( PbScoresValidation $request ){ //example
//*************************************************************

class PbScoresValidation extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
				...
				"d_score" => "nullable|numeric", //float('d_score')->nullable()
