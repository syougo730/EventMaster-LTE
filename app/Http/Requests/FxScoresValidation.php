...
//*************************************************************
// Rule
//1.  use App\Http\Requests\FxScoresValidation; //Add Controller
//2.  public function store( FxScoresValidation $request ){ //example
//*************************************************************

class FxScoresValidation extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
				"event_id" => "nullable|integer", //integer('event_id')->nullable()
