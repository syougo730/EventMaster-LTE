...
//*************************************************************
// Rule
//1.  use App\Http\Requests\HbScoresValidation; //Add Controller
//2.  public function store( HbScoresValidation $request ){ //example
//*************************************************************

class HbScoresValidation extends FormRequest
{
    /**
