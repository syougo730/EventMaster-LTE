...
//*************************************************************
// Rule
//1.  use App\Http\Requests\PasswordResetsValidation; //Add Controller
//2.  public function store( PasswordResetsValidation $request ){ //example
//*************************************************************

class PasswordResetsValidation extends FormRequest
{
    /**
