...
//*************************************************************
// Rule
//1.  use App\Http\Requests\SrScoresValidation; //Add Controller
//2.  public function store( SrScoresValidation $request ){ //example
//*************************************************************

class SrScoresValidation extends FormRequest
{
    /**
