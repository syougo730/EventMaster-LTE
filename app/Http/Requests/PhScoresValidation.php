...
//*************************************************************
// Rule
//1.  use App\Http\Requests\PhScoresValidation; //Add Controller
//2.  public function store( PhScoresValidation $request ){ //example
//*************************************************************

class PhScoresValidation extends FormRequest
{
    /**
