...
//*************************************************************
// Rule
//1.  use App\Http\Requests\TeamsValidation; //Add Controller
//2.  public function store( TeamsValidation $request ){ //example
//*************************************************************

class TeamsValidation extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
				"team_name" => "nullable|max:255", //string('team_name',255)->nullable()
